...
const CreateTemplate = () => {
  ...
  const handleSelectTags = (tag) => {
    //checking if tag is selected or not
    if (selectedTags.includes(tag)) {
      //if previously selected , then remove it
  ...
  //rerouting the user to homescreen if he is not admin and trying to access template page through url
  useEffect(() => {
  ...
  return (
    <div className="w-full px-4 lg:px-10 2xl:px-32 py-4 grid grid-cols-1 lg:grid-cols-12">
      ...
      <div className="col-span-12 lg:col-span-4 2xl:col-span-3 w-full flex-1 flex items-center justify-start flex-col gap-4 px-2">
        ...
        <input
          className="w-full px-4 py-3 rounded-md bg-transparent border border-gray-300 text-lg text-txtPrimary focus:text-black focus:shadow-md outline-none"
          type="text"
          name="title"
        ...
        <button
          type="button"
          className="w-full text-white bg-blue-700 rounded-md py-3"
          onClick={pushToCloud}
        >
          Save
        </button>
