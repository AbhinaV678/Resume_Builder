...
const Header = () => {
  ...
  const handleSearchTerm = (e) => {
    ...
    //write function to query on data.tags (get template data) and then present them on screen
  };
  ...
  return (
    <header className="w-full flex items-center justify-between px-4 py-3 lg:px-8 border-b border-gray-300 bg-bgPrimary z-50 gap-12 sticky top-0">
      ...
      <p className="text-cyan-950 text-opacity-60 text-3xl lg:text-4xl text-center text-wrap whitespace-nowrap">
                  ...
                  {isMenu && (
                    ...
                    >
                      ...
                      <div className="w-full flex-col items-start flex gap-8 pt-6">
                        <Link
                          className="text-txtLight hover:text-black text-base whitespace-nowrap"
                          to={`/profile/${data?.uid}`}
                        >
                          My Account
                        </Link>
                        ...
                        <div
                          ...
                          onClick={signOutUser}
                        >
                          <p className="group-hover:text-black text-txtLight">
                            Sign Out
                          </p>
                          <HiLogout className="group-hover:text-black text-txtLight" />
                        </div>
                      </div>
                    </motion.div>
                  )}
